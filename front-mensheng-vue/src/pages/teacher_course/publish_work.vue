<template>
    <div class="container">
        ...
        <Input class="title" v-model="value1" placeholder="请输入标题"></Input>
        ...
        <span class="attachments">
            ...
            <Upload multiple action="//jsonplaceholder.typicode.com/posts/">
                <Button class="formate" type="ghost" icon="ios-cloud-upload-outline">上传文件</Button>
            </Upload>
            <Button type="primary" size="large" class="submit" @click="submit()">发布</Button>
        </span>
    </div>
</template>
