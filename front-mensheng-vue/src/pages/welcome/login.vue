<template>
  <div>
    <div class="w1140 wrap">
      ...
      <div class="input">
        <h2>用户登录</h2>
        <p class="usr"><span>账号：</span><input type="text" v-model="username" @keyup.enter="login"></p>
        <p class="pwd"><span>密码：</span><input type="password" v-model="password" @keyup.enter="login"></p>
